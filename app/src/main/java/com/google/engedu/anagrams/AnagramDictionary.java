 ...
 *
 */
/* Currently the implementation is based on adding one letter to Anagrams. For running the adding two letter to anagrams part just change the method getAnagramsWithOneMoreLetter to getAnagramsWithTwoMoreLetters
in pickGoodStarterWord Method and also in the java class AnagramsActivity.java file.
 */
